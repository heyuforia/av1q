...
- **Hardware-accelerated decoding** — CUDA, D3D11VA (Windows), VideoToolbox (macOS), VAAPI (Linux) speed up quality measurement; encoding itself is always CPU
